 ...
 */
public final class TopcHttpUtil {

    private static Logger logger = LoggerFactory.getLogger(TopcHttpUtil.class);
    ...
    public static String sendGet(String url, String param) throws IOException {
        ...
        if (TopcStringUtils.isNotBlank(param)) {
            urlNameString += "?" + param;
        }
    ...
    public static String sendSSLPost(String url, String param) {
        ...
        try {
            ...
            logger.error("发送SSL POST 请求出现异常！", e);
        }
        return result.toString();
    }
